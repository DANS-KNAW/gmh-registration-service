...
public class NbnApi {
  ...
  @Operation(summary = "Returns registered locations for this URN:NBN {identifier}.", description = "Returns all registered locations for this {identifier}.<br>The identifier must have a prefix that matches the authenticated user. HTTP 404 otherwise.", security = { @SecurityRequirement(name = "UserLogin") }, tags = { "URN:NBN identifier" })
  ...
  public Response getLocationsByNbn(@Parameter(in = ParameterIn.PATH, description = "URN:NBN identifier", required = true) @PathParam("identifier") String identifier, @Context SecurityContext securityContext) throws NotFoundException {
  ...
  @Produces({ "application/json" })
  @Operation(summary = "Returns URN:NBN object (urn:nbn+locations) for this {identifier}.", description = "Returns URN:NBN object (urn:nbn+locations) for this {identifier}.<br>The identifier must have a prefix that matches the authenticated user. HTTP 404 otherwise.", security = { @SecurityRequirement(name = "UserLogin") }, tags = { "URN:NBN identifier" })
  @ApiResponses(value = { @ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = NbnLocationsObject.class))),
      ...
      @ApiResponse(responseCode = "404", description = "Supplied URN:NBN identifier not found") })
  public Response getNbnRecord(@Parameter(in = ParameterIn.PATH, description = "URN:NBN identifier", required = true) @PathParam("identifier") String identifier, @Context SecurityContext securityContext, @Context ServletContext context) throws NotFoundException {
  ...
  @ApiResponses(value = { @ApiResponse(responseCode = "200", description = "OK (updated existing)"),
  ...
  public Response updateNbnRecord(@Parameter(in = ParameterIn.DEFAULT, description = "A json object that contains the associated locations for the {identifier}", required = true) List<String> body
      ...
      , @Parameter(in = ParameterIn.PATH, description = "URN:NBN identifier", required = true) @PathParam("identifier") String identifier, @Context SecurityContext securityContext) throws NotFoundException {
